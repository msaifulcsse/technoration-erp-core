...
namespace Services.Helpers
{
    public class CryptoHelperService : ICryptoHelperService
    {
        ...
        private string PASSWORD_CHARS_NUMERIC = "123456789";
        private string PASSWORD_CHARS_SPECIAL = "&=";//$-+?_&=!%{}/ ChangeTo &=
        //private string EncryptionKey = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
        private string EncryptionKey = "01234$ABCDE=789FGHIJKLMN&56?aefghxqzOPQRSTUVWrtmcnospXYZ";
        #endregion
